...
def get_response(messages):
    ...
    # transformers Qwen2.5 Omni processors expect `audio`, not `audios`.
    # Keep a compatibility fallback for older wrappers that still expose `audios`.
    if "audio" in processor_sig.parameters:
