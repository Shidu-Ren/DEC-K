# Reference: https://github.com/EvolvingLMMs-Lab/lmms-eval/tree/main/lmms_eval/tasks/videommmu
...
def eval_videommmu(folder_path, qa_data):
    results = []
    for filename in os.listdir(folder_path):
        ...
        results.append(videommmu_process_results(example_anno, [example['response']])['mmmu_acc'])

    printable_results = videommmu_aggregate_results(results)
    return printable_results
