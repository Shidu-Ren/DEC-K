...
def get_model(args):
    if 'dummy' in args.model:
        model = DummyModel()
    elif 'qwen3vl' in args.model.lower() or 'qwen3-vl' in args.model.lower():
        model_path = args.model_path or args.model
        model = Qwen3VLText(model_path, max_new_tokens=args.max_new_tokens)
...
class Qwen3VLText():
    def __init__(self, model_name, max_new_tokens=128):
        ...
        attn_implementation = os.environ.get("VGEN_ATTENTION_IMPL", "sdpa")
